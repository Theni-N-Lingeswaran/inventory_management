...
Category.create!([{ category_name: 'Printer' }, { category_name: 'System' }, { category_name: 'Ink-jet', category_id: 1 },
                  { category_name: 'Laser-jet', category_id: 1 }, { category_name: 'Desktop', category_id: 2 }, { category_name: 'laser-jet', category_id: 2 }])

Product.destroy_all
Product.create([
                 { product_name: 'marq-printer', product_code: 'marq12345', product_detail: 'dot-matrix printer',
                   category_id: 3 }, { product_name: 'Acer laptop', product_code: 'laptop12345', product_detail: 'touch screen with optical mouse', category_id: 4 }
               ])
...
Compliant.create!([
                    { complaint_details: 'Printer not working', customer_id: 1, product_id: 1, user_id: 2, remarks: 'Dead Condition',
                      estimation_date: '2021-12-24', total_amount: '2553', status: 1 }, { complaint_details: 'Display not working', customer_id: 1, product_id: 2, user_id: 2, remarks: 'Display problem', estimation_date: '2021-12-24', total_amount: '5000', status: 2 }
                  ])

Invoice.destroy_all
Invoice.create!([{ compliant_id: 1, user_id: 2, total_amount: '2553', part_amount: '553' },
                 { compliant_id: 1, user_id: 2, total_amount: '2553', part_amount: '500' }, { compliant_id: 1, user_id: 2, total_amount: '5000', part_amount: '553' }, { compliant_id: 2, user_id: 2, total_amount: '5000', part_amount: '2500' }, { compliant_id: 2, user_id: 2, total_amount: '5000', part_amount: '1500' }, { compliant_id: 2, user_id: 2, total_amount: '5000', part_amount: '1000' }])
