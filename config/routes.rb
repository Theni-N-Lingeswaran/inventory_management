...
Rails.application.routes.draw do
  ...
  get '/super_admin_home/:token', to: 'dashboard#super_admin_index', as: 'super_admin_home'
  get '/admin_home/:token', to: 'dashboard#index', as: 'admin_home'
  get '/employee_home/:token', to: 'dashboard#index', as: 'employee_home'
  get '/customer_home/:token', to: 'customers#index', as: 'customer_home'
  ...
  get '/new_employee/:token', to: 'settings#new_employee', as: 'new_employee'
  post '/new_employee/:token', to: 'settings#create_employee', as: 'create_employee'
  get '/edit_employee/:token/:employee_id', to: 'settings#edit_employee'
  post '/update_employee/:token/:employee_id', to: 'settings#update_employee', as: 'update_employee'
  get '/manage_invoices/:token', to: 'settings#invoice_template', as: 'manage_invoices'
  get '/generate_invoice_pdf/:token', to: 'settings#generate_invoice', as: 'pdf_download'
